...
var external_web3_utils_ = __webpack_require__(1);
...
class nodeDetailManager_NodeDetailManager {
  constructor() {
    let {
  ...
  async getNodeDetails(_ref) {
    ...
    try {
      ...
      const hashedVerifierId = Object(external_web3_utils_["keccak256"])(verifierId);
      ...
      for (let index = 0; index < torusNodeEndpoints.length; index += 1) {
        ...
        updatedNodePub.push({
          X: Object(external_web3_utils_["toHex"])(pubKx).replace("0x", ""),
          Y: Object(external_web3_utils_["toHex"])(pubKy).replace("0x", "")
        });
      }
